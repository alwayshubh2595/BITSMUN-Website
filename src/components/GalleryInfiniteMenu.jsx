...
import '../styles/InfniteGalleryMenu.scss'
import Squares from './SquaresComp'
...
class InfiniteGridMenu {
  ...
  #initTexture() {
    ...
    Promise.all(this.items.map(item =>
      ...
      images.forEach((img, i) => {
        ...
        // Center-crop to a square source rect rather than stretching the whole
        // image into the cell, which distorted any non-square photo.
  ...
  #animate(deltaTime) {
    ...
    const scale = 0.28; // Increased from 0.25 to 0.4 for larger images
